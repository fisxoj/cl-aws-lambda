...
** With the docker image
   ...
   #+begin_src sh
     docker run --rm -it -v $PWD:/work:Z -e LAMBDA_SYSTEM_NAME="my-cool-function" quay.io/fisxoj/cl-lambda-builder:latest
     podman run --rm -it -v $PWD:/work:Z -e LAMBDA_SYSTEM_NAME="my-cool-function" quay.io/fisxoj/cl-lambda-builder:latest
   #+end_src
